...
int main(){
    ...
    // abs(c47 - c74) == 1
    // 4747.....47474 or 747474...74747
    if(abs(c47 - c74) == 0){      
        if(c4 >= c47 + 1 && c7 >= c74){
          int exr = c4 - (c74 + 1);
          int exrs = (c7 - c74);
          cout << 4;
          for(int j = 0; j < exr; j++) cout << 4;
          cout << 7;
          for(int i = 0; i < c47 - 1; i++) cout << 47;
          for(int i = 0; i < exrs; i++) cout << 7;
          cout << 4 << '\n';
        } else if(c7 >= c74 + 1 && c4 >= c47){
           int exr = c4 - c47;
           int exrs = c7 - c74 - 1;
           cout << 7;
           for(int i = 0; i < exr; i++) cout << 4;
           cout << 4;
           for(int i = 0; i < c74 - 1; i++) cout << 74;
           for(int i = 0; i < exrs ; ++i) cout << 7;
            cout << 7;
          cout << '\n';
        } else cout << -1 << '\n';
    } else{
        // 474747 (47 is greater)
      if(c47 > c74){
         if(c4 >= c47 && c7 >= c47){
          int ex4 = c4 - c47;
          int ex7 = c7 - c47;
          cout << 4;
          for(int i = 0; i < ex4; i++) cout << 4;
            cout << 7;
          for(int i = 0; i < c47 - 2; i++){
            cout << 47;
          }
          cout << 4;
          for(int i = 0; i < ex7 ; i++){
        ...
        if(c7 >= c74 && c4 >= c74){
          ...
          for(int i = 0; i < c74 - 2; ++i){
            cout << 74;
          }
          cout << 7;
          for(int i = 0; i < ex7; i++) cout << 7;
            cout << 4;
        } else cout << -1 << '\n';
      }
    }
