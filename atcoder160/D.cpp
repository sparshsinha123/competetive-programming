...
int main(){
    ...
    for(int i = 1; i <= N; i++){
       for(int j = i + 1; j <= N; j++){
           if(i < X){
              if(j < Y) res[min(j - i , X - i + 1 + Y - j)]++;
              else if(j == Y) res[1 + X - i]++;
              else if(j > Y) res[j - Y + 1 + X - i]++;
           } else if(i == X){
              if(j < Y) res[min(j - i , Y - X + 1 - (j - i))]++;
              else if(j == Y) res[1]++;
              else if(j > Y) res[j - Y + 1]++;
           } else if(i > X){
               if(j < Y) res[min(j - i , Y - X + 1 - (j - i))]++;
               else if(j == Y) res[min(j - i , Y - X + 1 - (j - i))]++;
               else if(j > Y) res[min(j - i , i - X + 1 + j - Y)]++;
           }
       }
    }
    for(int i = 1; i <= N - 1; i++){
