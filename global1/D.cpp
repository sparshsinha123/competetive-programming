...
int main(){
    ...
    // we consider an optimal solution.
     
     
     // Claim: An optimal solution always exists in which for every x we have
     // at most 2 triples of the form [x , x + 1 , x + 2]
     
     
     // Proof: if for some x we have k triples [x , x + 1 , x + 2] where k > 2
     // then it can be replaced as follows:
     // take k % 3 and call it kk
     // k[x , x + 1 , x + 2] = (k - kk)/3[x , x , x] + (k - kk)/3[x + 1, x + 1, x + 1]
     // + (k - kk)/3[x + 2 , x + 2 , x + 2] + (kk)[x, x + 1, x + 2]
