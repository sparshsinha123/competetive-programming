...
void solve(vll &v1 , vll &v2 , vll &v3 , ll &ans){
    int n1 = (int) v1.size();
    int n2 = (int) v2.size();
    int n3 = (int) v3.size();
    for(int i1 = 0; i1 < n1; i1++){
        int i2 = (int)(lower_bound(all(v2) , v1[i1]) - v2.begin());
        if(i2 != n2){
            int i3 = (int)(lower_bound(all(v3) , v2[i2]) - v3.begin());
            if(i3 != n3)    ans = min(ans , func(v1[i1] , v2[i2] , v3[i3]));
            if(i3 - 1 >= 0) ans = min(ans , func(v1[i1] , v2[i2] , v3[i3 - 1]));
            if(i3 + 1 < n3) ans = min(ans , func(v1[i1] , v2[i2] , v3[i3 + 1]));
        }
        if(i2 - 1 >= 0){
            int i3 = (int)(lower_bound(all(v3) , v2[i2 - 1]) - v3.begin());
            if(i3 != n3)    ans = min(ans , func(v1[i1] , v2[i2 - 1] , v3[i3]));
            if(i3 - 1 >= 0) ans = min(ans , func(v1[i1] , v2[i2 - 1] , v3[i3 - 1]));
            if(i3 + 1 < n3) ans = min(ans , func(v1[i1] , v2[i2 - 1] , v3[i3 + 1]));
        }
        if(i2 + 1 < n2){
            int i3 = (int)(lower_bound(all(v3) , v2[i2 + 1]) - v3.begin());
            if(i3 != n3)    ans = min(ans , func(v1[i1] , v2[i2 + 1] , v3[i3]));
     ...
     for(int i1 = 0; i1 < n1; i1++){
         int i2 = (int)(upper_bound(all(v2) , v1[i1]) - v2.begin());
            if(i2 != n2){
                int i3 = (int)(upper_bound(all(v3) , v2[i2]) - v3.begin());
                if(i3 != n3)    ans = min(ans , func(v1[i1] , v2[i2] , v3[i3]));
                if(i3 - 1 >= 0) ans = min(ans , func(v1[i1] , v2[i2] , v3[i3 - 1]));
                if(i3 + 1 < n3) ans = min(ans , func(v1[i1] , v2[i2] , v3[i3 + 1]));
            }
            if(i2 - 1 >= 0){
                int i3 = (int)(upper_bound(all(v3) , v2[i2 - 1]) - v3.begin());
                if(i3 != n3)    ans = min(ans , func(v1[i1] , v2[i2 - 1] , v3[i3]));
                if(i3 - 1 >= 0) ans = min(ans , func(v1[i1] , v2[i2 - 1] , v3[i3 - 1]));
                if(i3 + 1 < n3) ans = min(ans , func(v1[i1] , v2[i2 - 1] , v3[i3 + 1]));
            }
...
int main(){
    ...
    while(t--){
        ...
        ll ans = inf;
        solve(v[0] , v[1] , v[2] , ans);
        solve(v[0] , v[2] , v[1] , ans);
        solve(v[1] , v[0] , v[2] , ans);
        solve(v[1] , v[2] , v[0] , ans);
        solve(v[2] , v[1] , v[0] , ans);
        solve(v[2] , v[0] , v[1] , ans);
        cout << ans << '\n';
    }       
}
