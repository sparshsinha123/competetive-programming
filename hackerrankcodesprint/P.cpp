...
int main(){
    ...
    for(int i = 0; i < 3; i++){
        int cnxr = 0, cnor = 0 , cnxc = 0 , cnoc = 0;
        for(int j = 0; j < 3; j++){
            cnxr += (s[i][j] == 'X');
            cnor += (s[i][j] == 'O');
            cnxc += (s[j][i] == 'X');
    ...
    int cnx = 0, cno = 0;
    int cnvx = 0 , cnvo = 0; 
    if(s[0][0] == 'X' && s[1][1] == 'X' && s[2][2] == 'X') cout << "JESSE\n";
    else if(s[0][0] == 'O' && s[1][1] == 'O' && s[2][2] == 'O') cout << "WALTER\n";
    else if(s[0][2] == 'X' && s[1][1] == 'X' && s[2][0] == 'X') cout << "JESSE\n";
    else if(s[0][2] == 'O' && s[1][1] == 'O' && s[2][0] == 'O') cout << "WALTER\n";
}
